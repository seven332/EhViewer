...
public class IndicatingScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IndicatingScrollView);
        mIndicatorHeight = a.getDimensionPixelOffset(R.styleable.IndicatingScrollView_indicatorHeight, 1);
        mPaint.setColor(a.getColor(R.styleable.IndicatingScrollView_indicatorColor, Color.BLACK));

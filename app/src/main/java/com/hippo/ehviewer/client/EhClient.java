...
public class EhClient {
    ...
    public static final int METHOD_GET_SUGGESTION = 19;
    public static final int METHOD_GET_SUGGESTION_DETAIL = 20;
        ...
        protected Object doInBackground(Object... params) {
            try {
                switch (mMethod) {
                    ...
                    case METHOD_GET_SUGGESTION:
                        return EhEngine.getSuggestion(this,mOkHttpClient,(String)params[0]);
                    case METHOD_GET_SUGGESTION_DETAIL:
                        return EhEngine.getSuggestionDetail(this,mOkHttpClient,(String)params[0]);
                    default:

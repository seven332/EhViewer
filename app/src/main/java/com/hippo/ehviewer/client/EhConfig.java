...
public class EhConfig implements Cloneable {
    ...
    public static final int JAPANESE_TRANSLATED = 1024;
    public static final int JAPANESE_REWRITE = 2048;
    public static final int ENGLISH_ORIGINAL = 1;
    public static final int ENGLISH_TRANSLATED = 1025;
    public static final int ENGLISH_REWRITE = 2049;
    public static final int CHINESE_ORIGINAL = 10;
    public static final int CHINESE_TRANSLATED = 1034;
    public static final int CHINESE_REWRITE = 2058;
    public static final int DUTCH_ORIGINAL = 20;
    public static final int DUTCH_TRANSLATED = 1044;
    public static final int DUTCH_REWRITE = 2068;
    public static final int FRENCH_ORIGINAL = 30;
    public static final int FRENCH_TRANSLATED = 1054;
    public static final int FRENCH_REWRITE = 2078;
    public static final int GERMAN_ORIGINAL = 40;
    public static final int GERMAN_TRANSLATED = 1064;
    public static final int GERMAN_REWRITE = 2088;
    public static final int HUNGARIAN_ORIGINAL = 50;
    public static final int HUNGARIAN_TRANSLATED = 1074;
    public static final int HUNGARIAN_REWRITE = 2098;
    public static final int ITALIAN_ORIGINAL = 60;
    public static final int ITALIAN_TRANSLATED = 1084;
    public static final int ITALIAN_REWRITE = 2108;
    public static final int KOREAN_ORIGINAL = 70;
    public static final int KOREAN_TRANSLATED = 1094;
    public static final int KOREAN_REWRITE = 2118;
    public static final int POLISH_ORIGINAL = 80;
    public static final int POLISH_TRANSLATED = 1104;
    public static final int POLISH_REWRITE = 2128;
    public static final int PORTUGUESE_ORIGINAL = 90;
    public static final int PORTUGUESE_TRANSLATED = 1114;
    public static final int PORTUGUESE_REWRITE = 2138;
    public static final int RUSSIAN_ORIGINAL = 100;
    public static final int RUSSIAN_TRANSLATED = 1124;
    public static final int RUSSIAN_REWRITE = 2148;
    public static final int SPANISH_ORIGINAL = 110;
    public static final int SPANISH_TRANSLATED = 1134;
    public static final int SPANISH_REWRITE = 2158;
    public static final int THAI_ORIGINAL = 120;
    public static final int THAI_TRANSLATED = 1144;
    public static final int THAI_REWRITE = 2168;
    public static final int VIETNAMESE_ORIGINAL = 130;
    public static final int VIETNAMESE_TRANSLATED = 1154;
    public static final int VIETNAMESE_REWRITE = 2178;
    public static final int NA_ORIGINAL = 254;
    public static final int NA_TRANSLATED = 1278;
    public static final int NA_REWRITE = 2302;
    public static final int OTHER_ORIGINAL = 255;
    public static final int OTHER_TRANSLATED = 1279;
    public static final int OTHER_REWRITE = 2303;

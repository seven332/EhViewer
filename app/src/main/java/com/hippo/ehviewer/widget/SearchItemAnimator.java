...
public class SearchItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public SearchItemAnimator(RecyclerView holder) {
        mHolder = holder;
    }
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        final ValueAnimator objAnimator = ObjectAnimator.ofFloat(view, "translationX", view.getWidth());
        objAnimator.setDuration(getRemoveDuration());
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        final ValueAnimator objAnimator = ObjectAnimator.ofFloat(view, "alpha", 1f);
        objAnimator.setDuration(getAddDuration());
        objAnimator.addListener(
                new Animator.AnimatorListener() {
                    @Override
                    public void onAnimationStart(Animator animation) {

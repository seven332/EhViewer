...
public class DownloadManager implements SpiderQueen.OnSpiderListener {
    ...
    @Nullable
    private DownloadInfo createDownloadInfo(DownloadInfoRaw raw) {
        ...
        if (info != null) { // Get it in download list
            ...
            if (label == null) {
                ...
                if (list == null) {
                    ...
                    list = new LinkedList<>();
                    mMap.put(label, list);
                    // Maybe label is missing in mLabelList
    ...
    public interface DownloadInfoListener {
        ...
        void onRemove(DownloadInfo info);
    }

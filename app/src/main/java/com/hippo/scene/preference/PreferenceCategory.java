...
public class PreferenceCategory extends PreferenceBase {

    private String mTitle;

    public PreferenceCategory(String title) {
        mTitle = title;
    }

    @Override
    int getItemViewType() {
        return PreferenceCenter.TYPE_PEFERENCE_CATEGORY;
    }

    public static RecyclerView.ViewHolder createViewHolder(Context content, ViewGroup parent) {
        return new PreferenceCategoryHolder(LayoutInflater.from(content)
                .inflate(R.layout.preference_category, parent, false));
    }
